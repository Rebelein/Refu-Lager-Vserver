...
export const initialInventory: InventoryItem[] = [
  ...
  { id: '12', name: 'Presszange "Profi"', manufacturerItemNumbers: [], mainLocation: "Werkzeug", subLocation: 'Halterung 5', stocks: [], minStocks: [], changelog: [], suppliers: [], preferredWholesalerId: null, reorderStatus: {}, lastInventoriedAt: {}, imageUrl: null, itemType: 'item' },
];

export const initialMachines: Machine[] = [
    { id: 'machine-1', name: 'Presszange "Profi"', manufacturer: 'Rems', model: 'Power-Press SE', itemType: 'machine', rentalStatus: 'available', reservations: [], mainLocation: "Werkzeug", subLocation: 'Halterung 5', stocks: [], minStocks: [], manufacturerItemNumbers: [], changelog: [] },
];
